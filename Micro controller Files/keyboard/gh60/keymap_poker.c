...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* 0: qwerty */
    KEYMAP_ANSI(
        PMNS,PAST,PSLS,NLCK, ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC, VOLU,\
    ...
    KEYMAP_ANSI(
        ...
        TRNS, TRNS, UP, TRNS,   TRNS,FN2,TRNS,   UP,  TRNS,TRNS,TRNS,TRNS,TRNS,CALC,TRNS,HOME,INS, FN4, TRNS, \
              LEFT,DOWN,RGHT,   TRNS,TRNS,LEFT,DOWN,RGHT,TRNS,PSCR,SLCK,PAUS,TRNS,FN3, END,      TRNS, TRNS,\
        TRNS, TRNS,TRNS,TRNS,   TRNS,DEL, TRNS,WHOM,MUTE,VOLU,VOLD,TRNS,PGUP,PGDN,DEL,        TRNS, TRNS,TRNS,\
              TRNS, TRNS,       TRNS,TRNS,LALT,          FN1,                     TRNS,TRNS,TRNS,TRNS,TRNS),
};
    /* 1: colemak */
    /*KEYMAP_ANSI(
